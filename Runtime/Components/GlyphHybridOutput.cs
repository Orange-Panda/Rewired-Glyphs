...
{
	/// <summary>
	/// A <see cref="GlyphDisplay"/> element that will set it's <see cref="textMesh"/> and <see cref="image"/> components to the <see cref="GlyphDisplay.actionName"/>'s <see cref="Glyph.GetDescription"/> and <see cref="Glyph.GetSprite(AxisRange)"/> values respectively.
	/// </summary>
	/// <remarks>
