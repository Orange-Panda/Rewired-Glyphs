...
- Fixed RewiredGlyphManager.cs poll rate being affected by time scale ([GH-20](https://github.com/Orange-Panda/Rewired-Glyphs/issues/20))
...
- Fixed NullReferenceException in GlyphRichTextFormatter if text set before component enabled ([GH-17](https://github.com/Orange-Panda/Rewired-Glyphs/issues/17))
